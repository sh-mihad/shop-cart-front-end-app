...
function App() {
  ...
  <div class="bg-black text-white py-2 px-4 text-center text-sm relative">
    <p>Sign up and get 20% off to your first order. <a href="#" class="underline font-medium">Sign Up Now</a></p>
        ...
        <div class="product-grid grid-cols-4">
          ...
          <div class="bg-gray-100 rounded-lg overflow-hidden transition-transform hover:scale-[1.02] duration-300">
            ...
            <div class="p-4">
              ...
              <button class="w-full mt-2 bg-red-800 py-1 text-gray-100 rounded flex items-center justify-center">Remove from Cart</button>
            </div>
          </div>
          ...
          <div class="bg-gray-100 rounded-lg overflow-hidden transition-transform hover:scale-[1.02] duration-300">
            <div class="h-48 bg-gray-200 flex items-center justify-center">
              <img src="./assets/img/image 10-1.png" alt="Polo with Tipping Details"
                class="h-full w-auto object-cover" />
            </div>
            <div class="p-4">
              <h3 class="font-medium">Polo with Tipping Details</h3>
              <div class="flex items-center justify-between">
                <div class="flex items-center my-1">
                  <div class="flex text-yellow-400">
                  ...
                  <span class="text-xs text-gray-500 ml-1">1/5</span>
                </div>
                <span class="text-xs text-gray-700">(320 pcs left)</span>
              </div>
              <p class="font-bold">$180</p>
               <button class="disabled:bg-gray-700 disabled:text-gray-400 disabled:cursor-not-allowed w-full mt-2 bg-gray-800 py-1 text-gray-100 rounded flex items-center justify-center active:translate-y-1 transition-all active:bg-gray-900">Add to Cart</button>
            </div>
          </div>
          ...
          <div class="bg-gray-100 rounded-lg overflow-hidden transition-transform hover:scale-[1.02] duration-300">
            <div class="h-48 bg-gray-200 flex items-center justify-center">
              <img src="./assets/img/image 10-2.png" alt="Black Striped T-shirt"
                class="h-full w-auto object-cover" />
            </div>
            <div class="p-4">
              <h3 class="font-medium">Black Striped T-shirt</h3>
              <div class="flex items-center justify-between">
                <div class="flex items-center my-1">
                  <div class="flex text-yellow-400">
                ...
                <span class="text-xs text-gray-700">(420 pcs left)</span>
              </div>
              <div class="flex items-center">
                <p class="font-bold">$120</p>
                <p class="text-gray-400 line-through ml-2">$160</p>
               
              </div>
              <button disabled class="disabled:bg-gray-700 disabled:text-gray-400 disabled:cursor-not-allowed disabled:bg-gray-700 disabled:text-gray-400 disabled:cursor-not-allowed w-full mt-2 bg-gray-800 py-1 text-gray-100 rounded flex items-center justify-center active:translate-y-1 transition-all active:bg-gray-900 active:translate-y-1 transition-all active:bg-gray-900">Add to Cart</button>
            </div>
          </div>
          ...
          <div class="bg-gray-100 rounded-lg overflow-hidden transition-transform hover:scale-[1.02] duration-300">
            <div class="h-48 bg-gray-200 flex items-center justify-center">
              <img src="./assets/img/image 7-1.png" alt="Skinny Fit Jeans"
                class="h-full w-auto object-cover" />
            </div>
            <div class="p-4">
              ...
              <div class="flex items-center justify-between">
                ...
                <span class="text-xs text-gray-700">(20 pcs left)</span>
              </div>
              <div class="flex items-center">
                <p class="font-bold">$240</p>
                <p class="text-gray-400 line-through ml-2">$260</p>
          ...
          <div class="bg-gray-100 rounded-lg overflow-hidden transition-transform hover:scale-[1.02] duration-300">
            <div class="h-48 bg-gray-200 flex items-center justify-center">
              <img src="./assets/img/image 8-2.png" alt="Checkered Shirt" class="h-full w-auto object-cover" />
            </div>
            <div class="p-4">
          ...
          <div class="bg-gray-100 rounded-lg overflow-hidden transition-transform hover:scale-[1.02] duration-300">
            <div class="h-48 bg-gray-200 flex items-center justify-center">
              <img src="./assets/img/image 8.png" alt="Sleeve Striped T-shirt"
                class="h-full w-auto object-cover" />
            </div>
            <div class="p-4">
              <h3 class="font-medium">Sleeve Striped T-shirt</h3>
              <div class="flex items-center justify-between">
                <div class="flex items-center my-1">
                  <div class="flex text-yellow-400">
                    <span>★</span><span>★</span><span>★</span><span>★</span><span class="text-gray-300">★</span>
          ...
          <div class="bg-gray-100 rounded-lg overflow-hidden transition-transform hover:scale-[1.02] duration-300">
            <div class="h-48 bg-gray-200 flex items-center justify-center">
              <img src="./assets/img/image 9-1.png" alt="Vertical Striped Shirt"
                class="h-full w-auto object-cover" />
            </div>
            <div class="p-4">
              <h3 class="font-medium">Vertical Striped Shirt</h3>
              <div class="flex items-center justify-between">
                <div class="flex items-center my-1">
                  <div class="flex text-yellow-400">
                    <span>★</span><span>★</span><span>★</span><span>★</span><span class="text-gray-300">★</span>
              ...
              <div class="flex items-center">
                ...
                <p class="text-gray-400 line-through ml-2">$232</p>
          ...
          <div class="bg-gray-100 rounded-lg overflow-hidden transition-transform hover:scale-[1.02] duration-300">
            <div class="h-48 bg-gray-200 flex items-center justify-center">
              <img src="./assets/img/image 9-2.png" alt="Courage Graphic T-shirt"
                class="h-full w-auto object-cover" />
            </div>
            <div class="p-4">
              <h3 class="font-medium">Courage Graphic T-shirt</h3>
              <div class="flex items-center justify-between">
                <div class="flex items-center my-1">
                  <div class="flex text-yellow-400">
                    <span>★</span><span>★</span><span>★</span><span>★</span><span class="text-gray-300">★</span>
          ...
          <div class="bg-gray-100 rounded-lg overflow-hidden transition-transform hover:scale-[1.02] duration-300">
            <div class="h-48 bg-gray-200 flex items-center justify-center">
              <img src="./assets/img/image 9.png" alt="Loose Fit Bermuda Shorts"
                class="h-full w-auto object-cover" />
            </div>
            <div class="p-4">
              <h3 class="font-medium">Loose Fit Bermuda Shorts</h3>
              <div class="flex items-center justify-between">
                <div class="flex items-center my-1">
                  <div class="flex text-yellow-400">
                    <span>★</span><span>★</span><span>★</span><span>★</span><span class="text-gray-300">★</span>
                ...
                <span class="text-xs text-gray-700">(10 pcs left)</span>
              </div>
  ...
  {/* news latter */}
   <section class="bg-black text-white py-12 px-4 md:px-8 mt-12">
    <div class="container mx-auto max-w-4xl">
      <h2 class="text-3xl md:text-4xl font-bold mb-4">STAY UP TO DATE ABOUT<br/>OUR LATEST OFFERS</h2>
